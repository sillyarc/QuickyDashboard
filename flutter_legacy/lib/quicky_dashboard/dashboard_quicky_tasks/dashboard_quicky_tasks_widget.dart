...
import '/components/create_event_copy_copy_widget.dart';
                                        ...
                                        children: [
                                          Text(
                                            FFLocalizations.of(context).getText(
                                              'tqd8dgyc' /* Quicky Tasks Dashboard */,
                                            ),
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    padding: MediaQuery
                                                                        .viewInsetsOf(
                                                                            context),
                                                                    child:
                                                                        CreateEventCopyCopyWidget(
                                                                      tasks: gridViewTasksRecord
                                                                          .reference,
                                                                    ),
                                                                  ),
                                                                );
                                                                    ...
                                                                    if (gridViewTasksRecord
                                                                      ...
                                                                      Padding(
                                                                        ...
                                                                        child: FutureBuilder<
                                                                            UsersRecord>(
                                                                          future:
                                                                              UsersRecord.getDocumentOnce(gridViewTasksRecord.usuarioQueAceitouaTask!),
                                                                          builder:
                                                                              (context, snapshot) {
                                                                            // Customize what your widget looks like when it's loading.
                                                                            if (!snapshot.hasData) {
                                                                            ...
                                                                            return InkWell(
                                                                              ...
                                                                              child: Row(
                                                                                ...
                                                                                children: [
                                                                                  ...
                                                                                  Align(
                                                                                    alignment: AlignmentDirectional(0.4, -1.08),
                                                                                    child: InkWell(
                                                                                      splashColor: Colors.transparent,
                                                                                      focusColor: Colors.transparent,
                                                                                      hoverColor: Colors.transparent,
                                                                                      highlightColor: Colors.transparent,
                                                                                      onTap: () async {
                                                                                        await gridViewTasksRecord.reference.update({
                                                                                          ...mapToFirestore(
                                                                                            {
                                                                                              'usuarioQueAceitouaTask': FieldValue.delete(),
                                                                                            },
                                                                                          ),
                                                                                        });
                                                                                      },
