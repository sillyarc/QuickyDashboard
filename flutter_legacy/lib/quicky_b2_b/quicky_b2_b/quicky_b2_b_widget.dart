...
import 'quicky_b2_b_model.dart';
export 'quicky_b2_b_model.dart';

class QuickyB2BWidget extends StatefulWidget {
  const QuickyB2BWidget({super.key});

  static String routeName = 'QuickyB2B';
  static String routePath = 'quickyB2B';

  @override
  State<QuickyB2BWidget> createState() => _QuickyB2BWidgetState();
}

class _QuickyB2BWidgetState extends State<QuickyB2BWidget>
    with TickerProviderStateMixin {
  late QuickyB2BModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => QuickyB2BModel());
                          ...
                          child: wrapWithModel(
                            ...
                            child: WebNavCopyWidget(
                              ...
                              colorBgOne: FlutterFlowTheme.of(context)
                                  .primaryBackground,
                              textOne: FlutterFlowTheme.of(context).secondary,
                            ),
                          ),
                        ),
                      Expanded(
                                    ...
                                    FutureBuilder<List<ComunitysRecord>>(
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        return FlutterFlowDropDown<String>(
                                          ...
                                          options: dropDownComunitysRecordList
                                              .map((e) => e.comunityName)
                                              .toList(),
                                                                            ...
                                                                            Padding(
                                                                              ...
                                                                              child: Container(
                                                                                ...
                                                                                child: Padding(
                                                                                  ...
                                                                                  child: Text(
                                                                                    '${functions.quantodetokentem(flippableCardTasksPreProntasRecord.preco).toString()} Qs',
                                                            ...
                                                            Padding(
                                                              ...
                                                              child: Text(
                                                                FFLocalizations.of(
                                                                        context)
                                                                    .getText(
                                                                  'bbdxjqre' /* All information about the 
Qui... */
                                                                  ,
                                                                ),
                                                                style: FlutterFlowTheme.of(
                                                          ...
                                                          Padding(
                                                            ...
                                                            child: Text(
                                                              FFLocalizations.of(
                                                                      context)
                                                                  .getText(
                                                                'lm0z7ld8' /* All information about the 
Qui... */
                                                                ,
                                                              ),
                                                              style: FlutterFlowTheme
