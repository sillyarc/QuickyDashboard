      ...
      routes: [
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: MainCustomerListWidget.routeName,
              path: MainCustomerListWidget.routePath,
            ...
            FFRoute(
              ...
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'dashboardQuickyTasks')
            ...
            FFRoute(
              name: MainProfilePageCopyWidget.routeName,
              path: MainProfilePageCopyWidget.routePath,
              builder: (context, params) => MainProfilePageCopyWidget(),
            ),
            FFRoute(
              name: AppAnalysticsWidget.routeName,
              path: AppAnalysticsWidget.routePath,
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'appAnalystics')
                  : AppAnalysticsWidget(),
            ),
            FFRoute(
              ...
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'alluserapage')
                  : AlluserapageWidget(),
            ),
            FFRoute(
            ...
            FFRoute(
              name: EdittaskCopyWidget.routeName,
              path: EdittaskCopyWidget.routePath,
              builder: (context, params) => EdittaskCopyWidget(
                pretask: params.getParam(
                  'pretask',
                  ParamType.DocumentReference,
                  isList: false,
