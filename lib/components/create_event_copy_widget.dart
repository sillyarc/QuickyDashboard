  ...
  Widget build(BuildContext context) {
    return StreamBuilder<EventsRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final overlayEventsRecord = snapshot.data!;
                            ...
                            Padding(
                              ...
                              child: Container(
                                child: Align(
                                  ...
                                  child: Text(
                                    '${overlayEventsRecord.eventDescription} - ${overlayEventsRecord.complement} - Max People ${overlayEventsRecord.maximodepessoas.toString()}',
                                        ...
                                        Flexible(
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              'ypgwdekn' /* Espaço para localizacao */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
