...
import '/components/edit_steps_copy2_widget.dart';
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      FFLocalizations.of(context).getText(
                        'mi4jj641' /* Upload images about your compa... */,
                      ),
                          ...
                          children: [
                            Align(
                              ...
                              child: Container(
                                ...
                                child: Stack(
                                  children: [
                                    if (_model.uploadedFileUrl_uploadData3fb !=
                                            '')
                                      Padding(
                                        ...
                                        onPressed: () async {
                                          ...
                                          if (selectedMedia != null &&
                                            ...
                                            try {
                                              ...
                                              _model.isDataUploading_uploadData3fb =
                                                  false;
                                            }
                                            if (selectedUploadedFiles.length ==
                                                ...
                                                downloadUrls.length ==
                                                    selectedMedia.length) {
                                              safeSetState(() {
                                                _model.uploadedLocalFile_uploadData3fb =
                                                    selectedUploadedFiles.first;
                                                _model.uploadedFileUrl_uploadData3fb =
                                                    downloadUrls.first;
                                              });
                                            } else {
                                              safeSetState(() {});
                              ...
                              child: Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    labelText:
                                        FFLocalizations.of(context).getText(
                                      'akctu7jx' /* Location complement (SmartFit,... */,
                                    ),
                                    labelStyle: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
                              ...
                              Builder(
                                builder: (context) {
                                  ...
                                  return Column(
                                    mainAxisSize: MainAxisSize.max,
                                    children:
                                        List.generate(kits.length, (kitsIndex) {
                                      final kitsItem = kits[kitsIndex];
                                      return Row(
                                        mainAxisSize: MainAxisSize.max,
                                        mainAxisAlignment:
                                        ...
                                        children: [
                                          Text(
                                            '${kitsItem.description} - ${formatNumber(
                                              kitsItem.price,
                                  ...
                                  onPressed: () async {
                                    await EventsRecord.collection
                                        ...
                                        .set(createEventsRecordData(
                                          ...
                                          maximodepessoas: int.tryParse(
                                              _model.myBioTextController.text),
                                          comprarkitadiantado:
                                              _model.checkboxValue,
                                          location:
                                              _model.placePickerValue.latLng,
                                          horario: _model.datePicked,
                                          user: _model.instructor,
                                          complement: _model
