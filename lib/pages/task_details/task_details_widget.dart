                        ...
                        Column(
                          ...
                          children: [
                            Padding(
                              ...
                              child: Builder(
                                builder: (context) {
                                  final fotos = columnTasksRecord.foto.toList();
                                                                  ...
                                                                  builder:
                                                                    ...
                                                                    if (columnChatHistoryRecord
                                                                      ...
                                                                      return FutureBuilder<
                                                                          UsersRecord>(
                                                                        future:
                                                                            UsersRecord.getDocumentOnce(columnChatHistoryRecord.documentUser!),
                                                                        builder:
                                                                            (context,
                                                                                snapshot) {
                                                                          // Customize what your widget looks like when it's loading.
                                                                      ...
                                                                      return FutureBuilder<
                                                                          UsersRecord>(
                                                                        future:
                                                                            UsersRecord.getDocumentOnce(columnChatRecord!.user2Document!),
                                                                        builder:
                                                                            (context,
                                                                                snapshot) {
                                                                          // Customize what your widget looks like when it's loading.
