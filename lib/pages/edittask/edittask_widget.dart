...
import '/components/edit_steps_copy_copy_widget.dart';
import '/components/edit_steps_copy_widget.dart';
import '/components/edit_steps_widget.dart';
...
class EdittaskWidget extends StatefulWidget {
  ...
  static String routePath = 'edittask';
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<TasksPreProntasRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final edittaskTasksPreProntasRecord = snapshot.data!;
                                                ...
                                                child: Image.network(
                                                  edittaskTasksPreProntasRecord
                                                      ...
                                                      ? edittaskTasksPreProntasRecord
                                                          .foto
                                                      : _model
                                                          .uploadedFileUrl_uploadDataB1598,
                                                  width:
                                                    ...
                                                    if (selectedMedia != null &&
                                                        selectedMedia.every((m) =>
                                                            validateFileFormat(
                                                                ...
                                                                context))) {
                                                      safeSetState(() => _model
                                                              .isDataUploading_uploadDataB1598 =
                                                          true);
                                                      ...
                                                      try {
                                                        ...
                                                        _model.isDataUploading_uploadDataB1598 =
                                                            false;
                                                      }
                                                      if (selectedUploadedFiles
                                                          ...
                                                          downloadUrls.length ==
                                                              selectedMedia
                                                                  .length) {
                                                        safeSetState(() {
                                                          _model.uploadedLocalFile_uploadDataB1598 =
                                                              selectedUploadedFiles
                                                                  .first;
                                                          _model.uploadedFileUrl_uploadDataB1598 =
                                                              downloadUrls
                                                                  .first;
                                                        });
                                                      } else {
                            ...
                            children: [
                              Padding(
                                ...
                                child: Builder(
                                  builder: (context) {
                                    final materials =
                                        edittaskTasksPreProntasRecord.material
                                            .toList();
                          ...
                          Padding(
                            ...
                            child: TextFormField(
                              controller: _model.yourNameTextController1 ??=
                                ...
                                text: edittaskTasksPreProntasRecord.categoria,
                              ),
                          ...
                          Padding(
                            ...
                            child: TextFormField(
                              controller: _model.yourNameTextController2 ??=
                                  TextEditingController(
                                text: edittaskTasksPreProntasRecord.descricao,
                              ),
                              focusNode: _model.yourNameFocusNode2,
                              obscureText: false,
                              decoration: InputDecoration(
                                labelText: FFLocalizations.of(context).getText(
                                  '3nhq5vcu' /* Description */,
                                ),
                                labelStyle: FlutterFlowTheme.of(context)
                                    .bodySmall
                                    .override(
                              ...
                              StreamBuilder<List<TasksPreProntasRecord>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  List<TasksPreProntasRecord>
                                      dropDownTasksPreProntasRecordList =
                                      snapshot.data!;
                                  ...
                                  return FlutterFlowDropDown<String>(
                                    ...
                                    options: dropDownTasksPreProntasRecordList
                                        .map((e) => e.titulo)
                                        .toList(),
                              ...
                              Container(
                                ...
                                child: TextFormField(
                                  controller: _model.yourNameTextController3 ??=
                                      TextEditingController(
                                    text: formatNumber(
                                      edittaskTasksPreProntasRecord.preco,
                                      formatType: FormatType.decimal,
                    ...
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            await edittaskTasksPreProntasRecord.reference
                                .update(createTasksPreProntasRecordData(
                              titulo: _model.dropDownValue,
                              categoria: _model.yourNameTextController1.text,
                              descricao: _model.yourNameTextController2.text,
                              foto: _model.uploadedFileUrl_uploadDataB1598,
